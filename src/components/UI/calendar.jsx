        ...
        <div className="flex items-center justify-center gap-4 px-1 py-4 w-full h-12">
            ...
            <div className="flex gap-2 items-center">
                <select
                    ...
                    className="bg-neutral-800 text-yellow-500 font-bold border border-white/10 rounded-lg px-2 py-1.5 text-sm cursor-pointer hover:bg-neutral-700 outline-none appearance-auto"
                >
                    {months.map((m) => (
        ...
        <div onPointerDown={(e) => e.stopPropagation()} onClick={(e) => e.stopPropagation()}>
            <DayPicker
                ...
                classNames={{
                    ...
                    head_cell: "text-white/30 rounded-md w-9 font-normal text-[0.8rem] uppercase tracking-wider text-center py-2",
                    ...
                    day: cn(
                        ...
                        "h-9 w-9 p-0 font-normal aria-selected:opacity-100 font-mono text-white/70 hover:bg-yellow-500/20 hover:text-yellow-500 transition-all active:scale-95"
                    ),
                    day_range_end: "day-range-end",
                    day_selected: "!bg-yellow-500 !text-black hover:bg-yellow-500 hover:text-black focus:bg-yellow-500 focus:text-black font-bold rounded-md shadow-lg shadow-yellow-500/20",
                    day_today: "bg-white/5 text-yellow-500 font-bold decoration-yellow-500/30 underline-offset-4 underline rounded-md",
                    ...
                    dropdown_month: "mr-1",
                    dropdown_year: "ml-1",
                    dropdown: "bg-transparent text-white font-medium hover:bg-white/10 border border-white/10 rounded-sm px-1 py-0.5 text-sm cursor-pointer outline-none appearance-none text-center min-w-[80px]",
                    ...classNames,
                }}
                components={{
                    ...
                    Dropdown: ({ value, onChange, children, ...props }) => {
                        ...
                        return (
                            <select
                                className={cn(
                                    "bg-neutral-800 text-white font-bold hover:bg-neutral-700 border border-white/10 rounded-lg px-2 py-1.5 text-sm cursor-pointer outline-none appearance-auto transition-all z-[110] shadow-xl",
                                    props.className
                                )}
                                value={value}
                                onChange={onChange}
